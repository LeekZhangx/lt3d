 ...
 * minecraft
 */
const BLOCK_TEXTURE_TABLE_MC_1_21 = {
    "version": 1.21,
    "mods": {
        "minecraft":{
            ...
            "stripped_stem":{
                "parent": "minecraft:block/cube_column",
                "textures": {
                    "end": "minecraft:block/stripped_stem_top",
                    "side": "minecraft:block/stripped_stem"
                }
            },
            "stripped_hyphae":{
                "parent": "minecraft:block/cube_column",
                "textures": {
                    "end": "minecraft:block/stripped_stem",
                    "side": "minecraft:block/stripped_stem"
                }
            },
            "stripped_stripped_stem":{
                "parent": "minecraft:block/cube_column",
                "textures": {
                    "end": "minecraft:block/stripped_stripped_stem_top",
                    "side": "minecraft:block/stripped_stripped_stem"
                }
            },
            "stripped_stripped_hyphae":{
                "parent": "minecraft:block/cube_column",
                "textures": {
                    "end": "minecraft:block/stripped_stripped_stem",
                    "side": "minecraft:block/stripped_stripped_stem"
                }
            },
